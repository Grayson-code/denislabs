	...
	public async run(messageReaction: MessageReaction, user: User) {
		...
		switch (messageReaction.emoji.name) {
			...
			case '🖥️':
				...
				break;
			case '♂️':
				this.removeReaction('1076769787444731955', messageReaction, user);
				break;
			case '♀️':
				this.removeReaction('1076769834802630726', messageReaction, user);
				break;
			case '😁':
				this.removeReaction('1076769868101202050', messageReaction, user);
				break;
			case '🇻':
				this.removeReaction('1076769978948272138', messageReaction, user);
				break;
			case '🇲':
				this.removeReaction('1076770020652232757', messageReaction, user);
				break;
			case '🇨':
				this.removeReaction('1076770048816988222', messageReaction, user);
				break;
			case '🇫':
				this.removeReaction('1076770092223828028', messageReaction, user);
				break;
			case '🇦':
